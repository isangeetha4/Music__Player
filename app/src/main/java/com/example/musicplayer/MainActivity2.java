...
public class MainActivity2 extends AppCompatActivity {
    ImageView play, prev, next, imageView,replay_btn;
    TextView songTitle;
...
// creating an ArrayList to store our songs
        final ArrayList<Integer>
                songs = new ArrayList<>();
        songs.add(0, R.raw.huttidare );
        songs.add(1, R.raw.baarisu);
        songs.add(2, R.raw.zara);
        songs.add(3, R.raw.goblin);
        songs.add(4, R.raw.tujhe);
...
//
    ...
    private void songNames() {
        if (currentIndex == 0) {
            songTitle.setText("Huttidare Kannada Nadali Huttabeku");
            imageView.setImageResource(R.drawable.huttidare);
        }
        if (currentIndex == 1) {
            songTitle.setText("Baarisu Kannada Dim Dimava");
            imageView.setImageResource(R.drawable.baarisu);
        }
        if (currentIndex == 2) {
            songTitle.setText("zara zara");
            imageView.setImageResource(R.drawable.zara);
        }
        if (currentIndex == 3) {
            songTitle.setText("goblin");
        ...
        if (currentIndex == 4) {
            ...
            imageView.setImageResource(R.drawable.tuhje);
        }
// seekbar duration
